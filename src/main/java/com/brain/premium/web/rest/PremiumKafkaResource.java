...
@RestController
@RequestMapping("/api/premium-kafka")
public class PremiumKafkaResource {
    private final Logger log = LoggerFactory.getLogger(PremiumKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public PremiumKafkaResource(KafkaProperties kafkaProperties) {
